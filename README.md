# Бранч ветки emikhno/AT-helper. 
Попытка добавить масштабируемость страниц статистики, ибо задрало править в консоли браузера, чтобы снять скриншот :) И ещё цветом добавлено изменение количества переходов по столбцам. 
